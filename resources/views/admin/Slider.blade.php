                ...
                <div class="modal-body  text-center">
                    <div class="container">
                        <div class="row">
                            ...
                            <select name="button" id="button" class="custom-select mb-3 d-block">
                                ...
                                @for ($i = 0; $i <= 4; $i++)
                                    ...
                                    <option value="single-room-{{ $i }}">{{ $roomNames[$i] }}</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select name="button" id="button" class="custom-select mb-3 d-block">
                                    ...
                                    $roomNames=['Deluxe Single Room','Deluxe Double Room','Deluxe Twin Room','Executive
                                    Suite','Family Room'];
                                    $roomRoute=['single-room','double-room','twin-room','executive-room','family-room']
                                    @endphp

                                    @for ($i = 0; $i <= 4; $i++)

                                        <option value="{{ $roomRoute[$i] }}">{{ $roomNames[$i] }}</option>
...
@section('script')
    <script type="text/javascript">
        ...
        function sliderAdd(name, des, button, img) {
            ...
            if (name.length == 0) {
                ...
                toastr.error('Slider Page is empty!');
            } else {
        ...
        $('#SliderupdateConfirmBtn').click(function() {
            ...
            SliderUpdate(idUpdate, nameUpdate, desUpdate, button, img);
        ...
        function SliderUpdate(idUpdate, nameUpdate, desUpdate, button, imgUpdate) {
