<div class="row mt-5">
    <div class="col-md-10 offset-md-1 border border-dark">
                    ...
                    <div class="modal-body  text-center">
                        <div class="container">
                            <div class="row">
                                ...
                                <input id="RoomBed" type="text" class="form-control mb-3" placeholder="Room Bed">
                            </div>
                        </div>
                    </div>
        ...
        <!-- Room Delete -->
        <div class="modal fade" id="deleteModalRoom" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
        ...
        <!-- Room update -->
        <div class="modal fade" id="updateRoomModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body  text-center">
                        ...
                        <img id="RoomLoader" class="loding-icon m-5 d-none" src="{{ asset('loader.svg') }}" alt="">
