        ...
        <div id="mainDivimage" class="container-fluid d-none">
            <div class="row">
                <div class="col-md-12 p-2">
                    ...
                    <button id="addRoombtnimage" class="btn btn-sm btn-danger my-3">Add New</button>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body  text-center">
                    <div class="container">
                        <div class="row">
                            ...
                            <input type="file" id="imageimgRoom" class="form-control mb-3" name="text-input">
                ...
                <div class="modal-footer">
                    ...
                    <button id="RoomImageAddConfirmBtn" type="button" class="btn  btn-sm  btn-danger">Save</button>
                </div>
            </div>
        </div>
    </div>
