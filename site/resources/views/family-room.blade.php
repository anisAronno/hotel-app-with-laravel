@extends('layout.app')
@section('broadcramb','Family Room')
@section('content')
       <!-- Hero Section Begin -->
        ...
        <div class="col-md-8 pl-3 mt-3 mt-xl-5 ">
            <div class="container review-slider">
                <div class="mySlides">
                    ...
                    <img src="{{asset('client/images')}}/family.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <div class="numbertext">2 / 6</div>
                    <img src="{{asset('client/images')}}/family-room.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <div class="numbertext">3 / 6</div>
                    <img src="{{asset('client/images')}}/f-pic.jpg" style="width:100%">
                </div>
                ...
                <div class="row mt-3">
                    <div class="column">
                        <img class="demo cursor" src="{{asset('client/images')}}/family.png" style="width:100%; height: 100px;"
                            onclick="currentSlide(1)" alt="The Woods">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="{{asset('client/images')}}/family-room.png" style="width:100%; height: 100px;"
                            onclick="currentSlide(2)" alt="Cinque Terre">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="{{asset('client/images')}}/f-pic.jpg" style="width:100%; height: 100px;"
