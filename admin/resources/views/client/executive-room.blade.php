...
@section('content')
       ...
       <!-- Hero Section End -->
        ...
        <div class="room-config row bg-light px-5">
            ...
            </div><div class="col-md-4 col-sm-12 cart-section text-center">
                <p>Price</p>
            ...
            <div class="col-md-8 pl-3 mt-3 mt-xl-5 ">
                <div class="container review-slider">
                    <div class="mySlides">
                        ...
                        <img src="{{asset('client/images')}}/e-room.jpg" style="width:100% ">
                    </div>

                    <div class="mySlides">
                        <div class="numbertext">2 / 6</div>
                        <img src="{{asset('client/images')}}/e-room2.jpg" style="width:100%">
                    </div>


                    <div class="mySlides">
                        <div class="numbertext">3 / 6</div>
                        <img src="{{asset('client/images')}}/e-room3.jpg" style="width:100% ">
                    </div>

                    <div class="mySlides">
                        <div class="numbertext">4 / 6</div>
                        <img src="{{asset('client/images')}}/e-room4.jpg" style="width:100% ">
                    </div>

                    <div class="mySlides">
                        <div class="numbertext">5 / 6</div>
                        <img src="{{asset('client/images')}}/e-room5.jpg" style="width:100% ">
                    </div>

                    <div class="mySlides">
                        <div class="numbertext">6 / 6</div>
                        <img src="{{asset('client/images')}}/e-room6.jpg" style="width:100% ">
                    </div>

                    <div class="mySlides">
                        <div class="numbertext">7 / 6</div>
                        <img src="{{asset('client/images')}}/e-room7.jpg" style="width:100% ">
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="column">
                            <img class="demo cursor" src="{{asset('client/images')}}/e-room.jpg" style="width:100%; height: 100px;"
                                onclick="currentSlide(1)" alt="The Woods">
                        </div>
                        <div class="column">
                            <img class="demo cursor" src="{{asset('client/images')}}/e-room2.jpg" style="width:100%; height: 100px;"
                                onclick="currentSlide(2)" alt="Cinque Terre">
                        </div>
                        <div class="column">
                            <img class="demo cursor" src="{{asset('client/images')}}/e-room3.jpg" style="width:100%; height: 100px;"
                                onclick="currentSlide(3)" alt="Mountains and fjords">
                        </div>
                        <div class="column">
                            <img class="demo cursor" src="{{asset('client/images')}}/e-room4.jpg" style="width:100%; height: 100px;"
                                onclick="currentSlide(4)" alt="Northern Lights">
                        </div>
                        <div class="column">
                            <img class="demo cursor" src="{{asset('client/images')}}/e-room5.jpg" style="width:100%; height: 100px;"
                                onclick="currentSlide(5)" alt="Nature and sunrise">
                        </div>
                        <div class="column">
                            <img class="demo cursor" src="{{asset('client/images')}}/e-room6.jpg" style="width:100%; height: 100px;"
                                onclick="currentSlide(6)" alt="Snowy Mountains">
                        </div>
                        <div class="column">
                            <img class="demo cursor" src="{{asset('client/images')}}/e-room7.jpg" style="width:100%; height: 100px;"
